...
public class URLEncryption {
	...
	public static String FROM_CORIS_PARAMETER = "<";
	...
	public static String getParamAsString(HttpServletRequest request, String key, String defaultValue) {
		String encryptedParameters = getParamAsStringFromRequest(request, REQUEST_PARAMETER);
		if (TextUtil.isEmpty(encryptedParameters)) {
			String value = getParamAsStringFromRequest(request, key);
			...
			if (TextUtil.isEmpty(value)) {
				value = getParamAsStringFromRequest(request, key);
			}
			if (TextUtil.isEmpty(value)) {
	...
	public static String getParamAsStringFromRequest(HttpServletRequest request, String name) {
	...
	public static Date getParamAsDate(HttpServletRequest request, String name) {
		return getParamAsDate(request, name, DEFAULT_DATE_FORMAT);
	}
	...
	public static HashMap<String, String> getParameterPairs(String encryptedParameters) {
		HashMap<String, String> decryptedParameters = new HashMap<String, String>(); 
		try {
			String decrypted = new String(decryptStatic(encryptedParameters));
			if (decrypted != null && decrypted.length() > 0) {
				StringTokenizer st = new StringTokenizer(decrypted, "&");
				if (st.hasMoreTokens()) {
					while (st.hasMoreTokens()) {
	 ...
	 * parameter or null.
	 */
	public static Boolean getParamFromCheckBox(HttpServletRequest request, String name) {
		Boolean value = false;
