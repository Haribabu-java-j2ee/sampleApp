...
public class CorisReportNameIndexCivilReportCriteria extends ReportBaseSearchCriteria {
	
	public CorisReportNameIndexCivilReportCriteria(HttpServletRequest request) throws Exception {
		super(request);
