...
<body>
	<div class="container-fluid">
		<div class="card m-2">
			<div class="card-header">
				<strong>Termination Definitions</strong>
			</div>
			<div class="card-body">
	...
	<script>
		...
		function add() {
			...
			var title = "Add";
			var url = "/CorisWEB/PSCMaintenanceTerminationDefnServlet?psTerminationCode=&psTerminationDescr=&psTerminationDefnId=&mode=add&displayDisabled="+disabled;
			var width = 600;
			var height = 400;
