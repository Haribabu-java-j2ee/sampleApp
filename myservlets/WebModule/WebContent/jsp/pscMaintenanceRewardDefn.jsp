...
<head>
	...
	<title>Problem Solving Courts - Reward Definitions</title>
...
<body>
	<div class="container-fluid">
		<div class="card m-2">
			<div class="card-header">
				<strong>Reward Definitions</strong>
			</div>
			<div class="card-body">
			...
			<div class="card-header card-footer">
				<strong>Results</strong> <button onclick="add()" id="addBtn" class="btn btn-secondary btn-sm float-right">Add</button>
			</div>
			<div class="card-body">
	...
	<script>
		...
		function add() {
			...
			var title = "Add";
			var url = "/CorisWEB/PSCMaintenanceRewardDefnServlet?code=&descr=&mode=addPopup";
			var width = 600;
			var height = 400;
		...
		function displayList() {
			...
			appUX.ajax.call("/CorisWEB/PSCMaintenanceRewardDefnServlet", 
				...
				'POST', 
				'displayDisabled='+disabled+'&displayResults=true'
			);	
		}
	</script>
</body>
