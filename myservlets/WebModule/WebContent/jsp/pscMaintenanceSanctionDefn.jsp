...
<head>
	...
	<title>Problem Solving Courts - Sanction Definitions</title>
	...
	<div class="container-fluid">
		<div class="card m-2">
			<div class="card-header">
				<strong>Sanction Definitions</strong>
			</div>
			<div class="card-body">
	...
	<script>
		...
		function displayList() {
			...
			appUX.ajax.call("/CorisWEB/PSCMaintenanceSanctionDefnServlet", 
				...
				'POST', 
				'showRemoved='+displayRemoved+'&mode=list'
			);	
		}
		function add() {
			var cornId = "modalCornPrimary";
			var title = "Add";
			var url = "/CorisWEB/PSCMaintenanceSanctionDefnServlet?mode=add"; 
			var width = 600;
			var height = 400;
