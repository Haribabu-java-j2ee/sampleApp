...
<script>
	...
	function updateForm(description) {
		...
		if (validatedText) {
		   	...
		   	appUX.ajax.call('/CorisWEB/AdminAccessLevelServlet?mode=update&accessLevelId=<%= accessLevelDefnBO != null ? accessLevelDefnBO.getAccesslevelid() : 0 %>&courtType=<%= courtType %>&description=' + description , function (err, data, xhr) { refresh(); closePop(); });
		...
		<div class="container-fluid">
			<form class="form-inline" action="#" method="post">
				<div id="myModal" class="input-group m-4">
					...
					<input class="form-control" id="description" name="description" autofocus value="<%= accessLevelDefnBO != null ? TextUtil.print(accessLevelDefnBO.getDescription()) : "" %>" \>
