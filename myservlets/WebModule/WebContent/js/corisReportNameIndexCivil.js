...
function emailReport(format) {
	var title = "Name Index - Civil";
	var message = 'Would you like to receive an email with Name Index - Civil report?';
...
function loadCaseType(reportCategory) {
	if (reportCategory == "V") {
		$('#caseType').html($('#caseTypeCivilOptions').html());
	} else if (reportCategory == "D") {
		$('#caseType').html($('#caseTypeDomesticOptions').html());
	} else if (reportCategory == "P") {
		$('#caseType').html($('#caseTypeProbateOptions').html());
	} else if (reportCategory == "S") {
		$('#caseType').html($('#caseTypeSmallClaimsOptions').html());
	} else if (reportCategory == "A") {
		$('#caseType').html($('#caseTypeAllOptions').html());
	}
}
