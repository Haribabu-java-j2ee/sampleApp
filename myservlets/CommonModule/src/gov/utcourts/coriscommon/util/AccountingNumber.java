...
public class AccountingNumber implements Serializable, Comparable {
    ...
    private static final long serialVersionUID = 852235935895706111L;
    ...
    /**
     * Used to set the member variable bigDecimal. Sets scale and rounding every time. Should always be used to set bigDecimal.
     * 
     * @param bigDecimal
     ...
     * 
     * @param val
     *            The value by which this AccountingNumber is to be divided.
     * @param roundingMode
     ...
     *            The value by which this AccountingNumber is to be divided.
     * @param scale
     *            The scale of the AccountingNumber quotient to be returned.
     * @param roundingMode
     *            The rounding mode to apply.
     * @return An AccountingNumber whose value is (this / val).
     * @see #ROUND_UP
     ...
     * @param val
     *            The value to be multiplied by this AccountingNumber.
     * @return An AccountingNumber whose value is (this * val).
     */
    ...
    public String toString() {
        return NumberFormat.getNumberInstance().format(bigDecimal.doubleValue());
    }
