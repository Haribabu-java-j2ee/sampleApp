...
public class AisNotificationEmailCommon {
	
	private static Logger logger = Logger.getLogger(AisNotificationEmailCommon.class.getName());
	 ...
	 * @throws Exception
	 */
	public static void aisNotificationEmail(int caseMgtId, int systemId, byte[] attachment, String subject, String content, String sendTo, String sendFrom, String sendCC, String sendBcc, String courtType, String fileName, boolean isStatic) throws IOException{
		try {
			// Send Email
			...
			logger.error("aisNotificationEmail(int caseMgtId,  byte[] bytes, String subject, String content, String emailAddress, String courtType, String fileName, boolean isStatic) ", e);
		}
	}
}
