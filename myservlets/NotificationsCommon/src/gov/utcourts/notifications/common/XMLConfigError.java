...
/**
 * XMLConfig is a simple class that loads a global configuration
 * file
 **/
public class XMLConfigError {
	private static Properties properties;
	private static String propsFile = "/usr/local/WebSphere/AppServer/customlib/properties/ERRORMSG_Properties.xml";
	static {
		try {
